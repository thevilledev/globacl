...
- `globacl-control`: ACL authoring/API service with point-deny and compiled-rule authoring, a linearized in-process source of truth, and durable per-shard append logs.
